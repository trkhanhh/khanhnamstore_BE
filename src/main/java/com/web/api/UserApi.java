...
public class UserApi {
    ...
    public ResponseEntity<?> regisUser(@RequestBody UserRequest userRequest) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/register-user/" + user.getUsername())).body(result);
    }
    ...
    public ResponseEntity<?> getUserByRole(@RequestParam(value = "role", required = false) String role, @RequestParam(value = "q", required = false) String search, Pageable pageable) {
    ...
    public ResponseEntity<?> updateUser(@RequestBody UpdateUserRequest updateUserRequest) throws URISyntaxException {
        User updatedUser = userService.updateUser(updateUserRequest);
        return ResponseEntity.created(new URI("/api/user/update")).body(userMapper.userToUserDto(updatedUser));
    }
    ...
    public ResponseEntity<?> userList() {
        ...
        return new ResponseEntity<>(this.userMapper.listUserToListUserDto(userList), HttpStatus.OK);
    }
}
