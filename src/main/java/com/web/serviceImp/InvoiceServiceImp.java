...
public class InvoiceServiceImp implements InvoiceService {
    ...
    public InvoiceResponse updateStatus(Long invoiceId, Long statusId) {
        ...
        if (idSt == StatusUtils.DANG_CHO_XAC_NHAN || idSt == StatusUtils.DA_HUY) {
    ...
    public List<InvoiceResponse> findAll() {
        return this.invoiceMapper.invoiceListToInvoiceResponseList(this.invoiceRepository.findAll());
    }
