...
public class ProductCommentServiceImp implements ProductCommentService {
    ...
    @Override
    public List<ProductCommentResponse> getMostComment() {
        return this.productCommentRepository.getMostOfComments().stream().map((pc)->this.productCommentMapper.productCmtToProductCommentRes(pc)).toList();
    }
}
